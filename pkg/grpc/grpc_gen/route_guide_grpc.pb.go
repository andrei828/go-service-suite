...
func (c *routeGuideClient) ListFeatures(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error) {
	...
	x := &routeGuideListFeaturesClient{ClientStream: stream}
...
func (c *routeGuideClient) RouteChat(ctx context.Context, opts ...grpc.CallOption) (RouteGuide_RouteChatClient, error) {
	...
	x := &routeGuideRouteChatClient{ClientStream: stream}
	return x, nil
}
...
func _RouteGuide_ListFeatures_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RouteGuideServer).ListFeatures(m, &routeGuideListFeaturesServer{ServerStream: stream})
}
...
func _RouteGuide_RecordRoute_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RouteGuideServer).RecordRoute(&routeGuideRecordRouteServer{ServerStream: stream})
}
...
func _RouteGuide_RouteChat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RouteGuideServer).RouteChat(&routeGuideRouteChatServer{ServerStream: stream})
}
